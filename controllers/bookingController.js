...
exports.getBookings = async (req, res) => {
  try {
    ...
    let results = [];
    let totalCount = 0;
    let completedBookingsCount = 0; // ✅ count of completed bookings
    if (role === "talent") {
    ...
    // ✅ total hours only for completed bookings
    let totalHours = 0;
    let totalRate = 0;
    ...
    const bookings = {
      ...
      booking: Bookings.map(b => ({
        ...
        status: b.status,
        date: b.bookedSlots.length ? b.bookedSlots[0].booking_date : null,
        ...
        rating: b.rating || 0,
        totalHours: b.totalHoursForBooking
      })),
